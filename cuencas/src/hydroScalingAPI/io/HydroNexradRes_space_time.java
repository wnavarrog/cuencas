...
public class HydroNexradRes_space_time extends Object {
    ...
    public HydroNexradRes_space_time(java.io.File inputFile, java.io.File outputFile, java.io.File outputFileASC, java.io.File outputFileB, java.io.File outputFileASCB, int numRow, int numCol, float IniRes, float FinalRes,int Frow,int Fcol) throws java.io.IOException {
            ...
            File ASCOutNameB = new java.io.File(OutputDirsB+"/asc/"+Outfilename(fileName,"Asc"));
              ...
              {//System.err.println("ENTERING SPACE TIME LOOP:");
                // System.out.println(FileAscIn + "space " + NDecRes);
                  new HydroNexradRes_space_time(AsciiFile,BinaryOutName,ASCOutName,BinaryOutNameB,ASCOutNameB,ini_row,ini_col,orig_s_res,new_s_res,Frows,Fcolumns);
              } catch (Exception IOE){
