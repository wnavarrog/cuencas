...
public class Watershed extends Object{
     ...
     */
    public Watershed(int x, int y,int[][] xxyy, byte[][] fullDirMatrix, hydroScalingAPI.io.MetaRaster mr) {
        ...
        while(toMark != null){
            getWatershed(fullDirMatrix, idsBasin,toMark);
        }
    ...
    private void getWatershed(byte [][] fullDirMatrix, java.util.Vector idsBasin,int[][] ijs){
        ...
        for(int incoming=0;incoming<ijs.length;incoming++){
            ...
            for (int l = 0; l < xxyy_b.length; l++) {
                checkBounds|=(xxyy_b[l][1]==i && xxyy_b[l][0]==j);
            }
    ...
    public static void main0 (String args[]) {
        ...
        try{
            ...
            int[][] watershedBounds=new int[][] {{0,0},{0,0}};
            
            hydroScalingAPI.util.geomorphology.objects.Watershed laCuenca=new hydroScalingAPI.util.geomorphology.objects.Watershed(3154, 502,watershedBounds,matDirs,metaModif);
