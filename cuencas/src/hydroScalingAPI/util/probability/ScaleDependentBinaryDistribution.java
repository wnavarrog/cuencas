 ...
 */
public class ScaleDependentBinaryDistribution implements hydroScalingAPI.util.probability.ScaleDependentDiscreteDistribution{
     ...
     */
    public ScaleDependentBinaryDistribution(int n0, int n1, double p0,int ms) {
        value0=n0;
        value1=n1;
        p_value0=p0;
        maxScale=ms;
    ...
    public int sample(int scale) {
        int value=(Math.random()<p_value0)?value0:value1;
        //return 2*value*(maxScale-scale);
        return value*scale;
    }
    ...
    public static void main(String[] args) {
        ScaleDependentBinaryDistribution myUD=new ScaleDependentBinaryDistribution(1,2,0.2,1);
        for(int i=0;i<10;i++)
