...
public class HillSlopesInfo extends java.lang.Object {
    ...
    hydroScalingAPI.modules.rainfallRunoffModel.objects.SnowMeltManager thisSNOWEvent;
    hydroScalingAPI.modules.rainfallRunoffModel.objects.SnowCoverManager thisSNOWCoverEvent;
...
//        System.out.println("HillNumber="+HillNumber+"    dateRequested)="+dateRequested);
    ...
    public double SnowCover(int HillNumber, double timeInMinutes) {
        java.util.Calendar dateRequested = java.util.Calendar.getInstance();
        dateRequested.clear();
        dateRequested.setTimeZone(tz);
        dateRequested.setTimeInMillis((long) (timeInMinutes*60*1000));
//        System.out.println("HillNumber="+HillNumber+"    dateRequested)="+dateRequested);
        return thisSNOWCoverEvent.getSNOWCoverOnHillslope(HillNumber, dateRequested);
    }
...
//    }
    ...
    public void setSnowMeltManager(hydroScalingAPI.modules.rainfallRunoffModel.objects.SnowMeltManager SNOW) {
        thisSNOWEvent = SNOW;
    }

    public void setSnowCoverManager(hydroScalingAPI.modules.rainfallRunoffModel.objects.SnowCoverManager SNOWCover) {
        thisSNOWCoverEvent = SNOWCover;
    }
