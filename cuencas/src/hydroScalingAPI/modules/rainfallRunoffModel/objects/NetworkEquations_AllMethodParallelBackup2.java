 ...
 */
public class NetworkEquations_AllMethodParallelBackup2 implements hydroScalingAPI.util.ordDiffEqSolver.BasicFunction {
...
//                    double Pe = hillAcumevent - Ia;
            ...
            case 2012:
                ...
                for (int i = 0; i < nLi; i++) {
                    ...
                    if (ai > 0 && hrel > 0 && hrelmax > 0) {
                        ...
                        qs_l = (Ksat * hrel * lengthArray[0][i] * 2 / (ai * 1e3)) * (ai / aH[0][i]);  //mm/hour // correct units!!!!!
                        //////  134   qs_l = Ksat * 1000 * (ai / aH[0][i])* (hrel / hrelmax);  //mm/hour // correct units!!!!!
                    } else {
                        qs_l = 0;
                    }
            ...
            case 2013:
                ...
                for (int i = 0; i < nLi; i++) {
                    ...
                    /*surface hillslope reservoir*/ output[i + nLi] = (1 / 60.) * (qp - qp_l - qp_u - ev_surf + snow); //output[mm/h/min]
                    if (Double.isNaN(output[i + nLi])) {
                        output[i + nLi] = 0.0;
                    }
                    /* depth - saturated area*/
            ...
            case 2021:
                ...
                for (int i = 0; i < nLi; i++) {
                    ...
                    /* the links*/ output[i] = 60 * K_Q * ((1 / 3.6 * ((aH[0][i] * (qp_l + snow)))) + Q_trib - input[i]); //[m3/s]/min

                    if (Double.isNaN(output[i])) {
                        output[i] = 0.0;
                    }

                    /*surface hillslope reservoir*/ output[i + nLi] = (1 / 60.) * (qp - qp_l - qp_u - ev_surf + qs_l); //output[mm/h/min]
                    if (Double.isNaN(output[i + nLi])) {
                        output[i + nLi] = 0.0;
                    }
                    /* depth - saturated area*/
            ...
            case 2023:
                ...
                for (int i = 0; i < nLi; i++) {
                    ...
                    if (ai >= 0 && hrel >= 0 && hrelmax > 0.001) {
                        ...
                        qs_l = Slope * Ksat * 1000 * (ai / aH[0][i]) * (hrel / hrelmax);  //mm/hour // correct units!!!!!
            ...
            case 2024:
                ...
                for (int i = 0; i < nLi; i++) {
                    ...
                    if (ai >= 0 && hrel >= 0 && hrelmax > 0.001) {
                        ...
                        qs_l = Slope * Ksat * 1000 * (ai / aH[0][i]);  //mm/hour // correct units!!!!!
            ...
            case 2025:
                ...
                for (int i = 0; i < nLi; i++) {
                    ...
                    if (ai >= 0 && hrel >= 0 && hrelmax > 0.001) {
                        ...
                        qs_l = input[i + 3 * nLi] * Slope * Ksat * 1000 * (ai / aH[0][i]);  //mm/hour // correct units!!!!!
            ...
            case 2027:
                ...
                for (int i = 0; i < nLi; i++) {
                    ...
                    if (ai >= 0 && hrel >= 0 && hrelmax > 0.001) {
                        ...
                        qs_l = input[i + 3 * nLi] * (Vs_sat / Vt[0][i]) * Slope * Ksat * 1000 * (ai / aH[0][i]);  //mm/hour // correct units!!!!!
            ...
            case 20263:
                ...
                for (int i = 0; i < nLi; i++) {
                    ...
                    //
                    double Cunsat = input[i + 3 * nLi] * (av_depth_uns / hb[0][i]) * (ap / aH[0][i]);
                    double Csat = (av_depth_sat / hb[0][i])*input[i + 3 * nLi] ;
                    double SC = Cs + Cunsat + Csat;
                    double Corr = 1;
                    if (SC > 1) {
                        Corr = 1 / SC;
