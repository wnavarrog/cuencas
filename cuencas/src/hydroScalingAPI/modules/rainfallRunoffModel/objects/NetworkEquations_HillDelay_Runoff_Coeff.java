 ...
 */
public class NetworkEquations_HillDelay_Runoff_Coeff implements hydroScalingAPI.util.ordDiffEqSolver.BasicFunction {
     ...
     */
    public NetworkEquations_HillDelay_Runoff_Coeff(hydroScalingAPI.util.geomorphology.objects.LinksAnalysis links, hydroScalingAPI.modules.rainfallRunoffModel.objects.HillSlopesInfo hillinf, hydroScalingAPI.modules.rainfallRunoffModel.objects.LinksInfo linkIn, int rt){
