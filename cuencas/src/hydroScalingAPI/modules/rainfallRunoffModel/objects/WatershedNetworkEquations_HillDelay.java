 ...
 */
public class WatershedNetworkEquations_HillDelay implements hydroScalingAPI.util.ordDiffEqSolver.BasicFunction {
     ...
     * <p>5: Velocity based on parameterization v=Ck*q^lambda1*A^lambda2</p>
     */
    public WatershedNetworkEquations_HillDelay(hydroScalingAPI.util.geomorphology.objects.LinksAnalysis links, hydroScalingAPI.modules.rainfallRunoffModel.objects.HillSlopesInfo hillinf, hydroScalingAPI.modules.rainfallRunoffModel.objects.LinksInfo linkIn, int rt, int[] connectingLinks, java.io.File[] inputFiles) {
