 ...
 */
public class SimulationToAsciiAndre extends java.lang.Object implements Runnable{
    ...
    public SimulationToAsciiAndre(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, float rainIntensity, float rainDuration, float infiltRate, int routingType, java.io.File outputDirectory,java.util.Hashtable routingParams) throws java.io.IOException, VisADException{
        this(x,y,direcc,magnitudes,md,rainIntensity,rainDuration,null,null,infiltRate,routingType,outputDirectory,routingParams);
    }
    public SimulationToAsciiAndre(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, java.io.File stormFile, float infiltRate,int routingType, java.io.File outputDirectory,java.util.Hashtable routingParams) throws java.io.IOException, VisADException{
        this(x,y,direcc,magnitudes,md,0.0f,0.0f,stormFile,null,infiltRate,routingType,outputDirectory,routingParams);
    }
    public SimulationToAsciiAndre(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, java.io.File stormFile, hydroScalingAPI.io.MetaRaster infiltMetaRaster, int routingType, java.io.File outputDirectory,java.util.Hashtable routingParams) throws java.io.IOException, VisADException{
        this(x,y,direcc,magnitudes,md,0.0f,0.0f,stormFile,infiltMetaRaster,0.0f,routingType,outputDirectory,routingParams);
    }
    public SimulationToAsciiAndre(int xx, int yy, byte[][] direcc, int[][] magnitudesOR, 
...
//        thisHillsInfo.setInfManager(infilMan);
    ...
    public static void subMain0(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiAndre(x_outlet,y_outlet,matDirs,magnitudes,metaModif,50,1,0.0f,1,new java.io.File("/home/ricardo/workFiles/myWorkingStuff/MateriasDoctorado/PhD_Thesis/results/flowSimulations/realBasins"),routingParams).executeSimulation();
    ...
    public static void subMain1(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiAndre(32,32,matDirs,magnitudes,metaModif,6,10,0.0f,2,new java.io.File("/tmp/"),routingParams).executeSimulation();
        new SimulationToAsciiAndre(32,32,matDirs,magnitudes,metaModif,6,10,0.0f,1,new java.io.File("/tmp/"),routingParams).executeSimulation();
        ...
        new SimulationToAsciiAndre(777, 324,matDirs,magnitudes,metaModif,stormFile,0.0f,0,new java.io.File("/tmp/"),routingParams);
        ...
        new SimulationToAsciiAndre(777, 324,matDirs,magnitudes,metaModif,stormFile,0.0f,2,new java.io.File("/tmp/"),routingParams);
    ...
    public static void subMain2(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiAndre(194,281,matDirs,magnitudes,metaModif,  20,5,0.0f,2,new java.io.File("/home/ricardo/simulationResults/walnutGulch/"),routingParams).executeSimulation();
    }
    ...
    public static void subMain3(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiAndre(381, 221,matDirs,magnitudes,metaModif,new java.io.File("/CuencasDataBases/Upper Rio Puerco DB/Rasters/Hydrology/Rainfall/nexrad_prec.metaVHC"),0.0f,0,new java.io.File("/tmp/"),routingParams).executeSimulation();
    ...
    public static void subMain4(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiAndre(1063,496,matDirs,magnitudes,metaModif,stormFile,0.0f,5,new java.io.File("/home/ricardo/simulationResults/walnutGulch/"),routingParams).executeSimulation();
    }
...
//        new SimulationToAsciiFile(778, 368, matDirs, magnitudes, metaModif, 10000.0f, 15.0f, 30.0f, 2, new java.io.File("E:/CUENCAS/ClearCreek_Database/Results/"), routingParams).executeSimulation();
        new SimulationToAsciiAndre(1570, 127, matDirs, magnitudes, metaModif, 1000.0f, 15.0f, 30.0f, 2, new java.io.File("C:/CuencasDataBases/ClearCreek_Database/Results/"), routingParams).executeSimulation();
        ...
        new SimulationToAsciiAndre(1570, 127, matDirs, magnitudes, metaModif, stormFile, infil, 5, new java.io.File("/Users/ricardo/simulationResults/ClearCreek/"), routingParams).executeSimulation();
        ...
        for (double lam1 = 3; lam1 <= 3; lam1 += 1) {
            ...
            for (double lam2 = -1; lam2 <= -1; lam2 += 1.0) {
                ...
                for (float intV = 3.5f; intV <= 3.5f; intV += 1.0) {
                    ...
                    new SimulationToAsciiAndre(1570, 127, matDirs, magnitudes, metaModif, stormFile, infil, 5, new java.io.File("/home/ricardo/simulationResults/ClearCreek/"), routingParams).executeSimulation();
                }
            }
        }
    }
    ...
    public static void subMain6(String args[]) throws java.io.IOException, VisADException {
        ...
        routingParams.put("v_o", 0.5f);
        new SimulationToAsciiAndre(1425, 349, matDirs, magnitudes, metaModif, stormFile, infil, 2, new java.io.File("/Users/ricardo/simulationResults/SquawCreek/"), routingParams).executeSimulation();
...
//        int[] event_num={35};
        ...
        for (int i : event_num) {
            ...
            new SimulationToAsciiAndre(44, 111, matDirs, magnitudes, metaModif, stormFile, infil, 5, new java.io.File("/Users/ricardo/simulationResults/GoodwinCreek/"), routingParams).executeSimulation();
