 ...
 */
public class SimulationToFileHillslopeModel extends java.lang.Object implements Runnable {
    ...
    public SimulationToFileHillslopeModel(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, float rainIntensity, float rainDuration, float infiltRate, java.io.File outputDirectory, float LandUseFileFlag, float SoilFileFlag, java.util.Hashtable routingParams) throws java.io.IOException, VisADException {
    ...
    public SimulationToFileHillslopeModel(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, java.io.File stormFile, float infiltRate, java.io.File outputDirectory, float LandUseFileFlag, float SoilFileFlag, java.util.Hashtable routingParams) throws java.io.IOException, VisADException {
    ...
    public SimulationToFileHillslopeModel(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, java.io.File stormFile, float infiltRate, java.io.File outputDirectory, java.io.File LandUseFile, java.io.File SoilFile, java.util.Hashtable routingParams) throws java.io.IOException, VisADException {
    ...
    public SimulationToFileHillslopeModel(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, java.io.File stormFile, float infiltRate, int greenroof, java.io.File GreenFile, java.io.File outputDirectory, java.io.File LandUseFile, java.io.File SoilFile, java.util.Hashtable routingParams) throws java.io.IOException, VisADException {
    ...
    public SimulationToFileHillslopeModel(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, float rainIntensity, float rainDuration, float infiltRate, java.io.File outputDirectory, java.io.File LandUseFile, java.io.File SoilFile, java.util.Hashtable routingParams) throws java.io.IOException, VisADException {
    ...
    public SimulationToFileHillslopeModel(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, java.io.File stormFile, hydroScalingAPI.io.MetaRaster infiltMetaRaster, int greenroof, java.io.File GreenFile, java.io.File outputDirectory, float LandUseFileFlag, java.io.File LandUseFile, float SoilFileFlag, java.io.File SoilFile, java.util.Hashtable routingParams) throws java.io.IOException, VisADException {
    ...
    public SimulationToFileHillslopeModel(int xx, int yy, byte[][] direcc, int[][] magnitudesOR,
...
//               newfile.write(thisHillsInfo.SCS_S3(i)+" ");
        ...
        for (int i = 0; i < linksStructure.contactsArray.length; i++) {
            if (thisNetworkGeom.linkOrder(i) > 3) {
                newfile1.write(thisNetworkGeom.linkOrder(i) + ",");
            }
        }
        newfile1.write("\n");
        ...
        for (int i = 0; i < linksStructure.contactsArray.length; i++) {
            if (thisNetworkGeom.linkOrder(i) > 3) {
                newfile1.write(thisNetworkGeom.upStreamArea(i) + ",");
            }
        }
        newfile1.write("\n");
...
//            } else {
            rainRunoffRaining.jumpsRunCompleteToAsciiFileSCSsimple(storm.stormInitialTimeInMinutes() + k * storm.stormRecordResolutionInMinutes(), storm.stormInitialTimeInMinutes() + (k + 1) * storm.stormRecordResolutionInMinutes(), outputTimeStep, initialCondition, newfile, linksStructure, thisNetworkGeom, newfile1, newfile3);
//            }
    ...
    public static void subMainManning(String args[]) throws java.io.IOException, VisADException {
        ...
        for (int i = 0; i < nsim; i++) {
            for (int ib = 0; ib < nbas; ib++) {
                ...
                stormFile = new java.io.File("/Users/luciana-cunha/Documents/CuencasDataBases/Iowa_Rivers_DB/Rasters/Hydrology/storms/simulated_events/AveragedEventIowaJuneMPE/May29toJune26/hydroNexrad.metaVHC");
