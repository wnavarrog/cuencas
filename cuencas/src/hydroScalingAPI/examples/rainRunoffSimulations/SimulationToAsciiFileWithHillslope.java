 ...
 */
public class SimulationToAsciiFileWithHillslope extends java.lang.Object implements Runnable{
    ...
    public SimulationToAsciiFileWithHillslope(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, float rainIntensity, float rainDuration, float infiltRate, int routingType, java.io.File outputDirectory,java.util.Hashtable routingParams) throws java.io.IOException, VisADException{
        this(x,y,direcc,magnitudes,md,rainIntensity,rainDuration,null,null,infiltRate,routingType,outputDirectory,routingParams);
    }
    public SimulationToAsciiFileWithHillslope(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, java.io.File stormFile, float infiltRate,int routingType, java.io.File outputDirectory,java.util.Hashtable routingParams) throws java.io.IOException, VisADException{
        this(x,y,direcc,magnitudes,md,0.0f,0.0f,stormFile,null,infiltRate,routingType,outputDirectory,routingParams);
    }
    public SimulationToAsciiFileWithHillslope(int x, int y, byte[][] direcc, int[][] magnitudes, hydroScalingAPI.io.MetaRaster md, java.io.File stormFile, hydroScalingAPI.io.MetaRaster infiltMetaRaster, int routingType, java.io.File outputDirectory,java.util.Hashtable routingParams) throws java.io.IOException, VisADException{
        this(x,y,direcc,magnitudes,md,0.0f,0.0f,stormFile,infiltMetaRaster,0.0f,routingType,outputDirectory,routingParams);
    }
    public SimulationToAsciiFileWithHillslope(int xx, int yy, byte[][] direcc, int[][] magnitudesOR, 
...
//        }
        ...
        newfile.write("Information on all links\n");
        newfile.write("Link #,");
        ...
        hydroScalingAPI.modules.rainfallRunoffModel.objects.NetworkEquations_HillDelayPlusLinearHillslope thisBasinEqSys=new hydroScalingAPI.modules.rainfallRunoffModel.objects.NetworkEquations_HillDelayPlusLinearHillslope(linksStructure,thisHillsInfo,thisNetworkGeom,routingType);
        ...
        if(stormFile == null){
            for (int k=0;k<numPeriods;k++) {
                ...
                //rainRunoffRaining.jumpsRunToAsciiFileHillType1(storm.stormInitialTimeInMinutes()+k*rainDuration,storm.stormInitialTimeInMinutes()+(k+1)*rainDuration,rainDuration,initialCondition,newfile,linksStructure,thisNetworkGeom);
            ...
            //rainRunoffRaining.jumpsRunToAsciiFileHillType1(storm.stormInitialTimeInMinutes()+numPeriods*rainDuration,(storm.stormInitialTimeInMinutes()+(numPeriods+1)*rainDuration)+8000,15,initialCondition,newfile,linksStructure,thisNetworkGeom);
            
        } else {
            for (int k=0;k<numPeriods;k++) {
                System.out.println("Period "+(k+1)+" of "+numPeriods);
                //rainRunoffRaining.jumpsRunToAsciiFileHillType1(storm.stormInitialTimeInMinutes()+k*storm.stormRecordResolutionInMinutes(),storm.stormInitialTimeInMinutes()+(k+1)*storm.stormRecordResolutionInMinutes(),15,initialCondition,newfile,linksStructure,thisNetworkGeom);
                initialCondition=rainRunoffRaining.finalCond;
                rainRunoffRaining.setBasicTimeStep(10/60.);
            }
            ...
            //rainRunoffRaining.jumpsRunToAsciiFileHillType1(storm.stormInitialTimeInMinutes()+numPeriods*storm.stormRecordResolutionInMinutes(),(storm.stormInitialTimeInMinutes()+(numPeriods+1)*storm.stormRecordResolutionInMinutes())+2400,15,initialCondition,newfile,linksStructure,thisNetworkGeom);
        }
    ...
    public static void subMain0(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiFileWithHillslope(x_outlet,y_outlet,matDirs,magnitudes,metaModif,50,1,0.0f,1,new java.io.File("/Users/ricardo/workFiles/myWorkingStuff/MateriasDoctorado/PhD_Thesis/results/flowSimulations/realBasins"),routingParams).executeSimulation();
    ...
    public static void subMain1(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiFileWithHillslope(32,32,matDirs,magnitudes,metaModif,6,10,0.0f,2,new java.io.File("/tmp/"),routingParams).executeSimulation();
        new SimulationToAsciiFileWithHillslope(32,32,matDirs,magnitudes,metaModif,6,10,0.0f,1,new java.io.File("/tmp/"),routingParams).executeSimulation();
        ...
        new SimulationToAsciiFileWithHillslope(777, 324,matDirs,magnitudes,metaModif,stormFile,0.0f,0,new java.io.File("/tmp/"),routingParams);
        ...
        new SimulationToAsciiFileWithHillslope(777, 324,matDirs,magnitudes,metaModif,stormFile,0.0f,2,new java.io.File("/tmp/"),routingParams);
    ...
    public static void subMain2(String args[]) throws java.io.IOException, VisADException {
        ...
        //new SimulationToAsciiFile(420,303,matDirs,magnitudes,metaModif,150, 2,3.0f,2,new java.io.File("/Users/ricardo/simulationResults/walnutGulch/")).executeSimulation();
        //new SimulationToAsciiFile(194,281,matDirs,magnitudes,metaModif, 50, 6,3.0f,2,new java.io.File("/Users/ricardo/simulationResults/walnutGulch/")).executeSimulation();
        //new SimulationToAsciiFile(194,281,matDirs,magnitudes,metaModif, 10,30,3.0f,2,new java.io.File("/Users/ricardo/simulationResults/walnutGulch/")).executeSimulation();
        //new SimulationToAsciiFile(194,281,matDirs,magnitudes,metaModif,  5,60,3.0f,2,new java.io.File("/Users/ricardo/simulationResults/walnutGulch/")).executeSimulation();

        new SimulationToAsciiFileWithHillslope(194,281,matDirs,magnitudes,metaModif,  20,5,0.0f,2,new java.io.File("/Users/ricardo/simulationResults/walnutGulch/"),routingParams).executeSimulation();
    }
    ...
    public static void subMain3(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiFileWithHillslope(381, 221,matDirs,magnitudes,metaModif,new java.io.File("/hidrosigDataBases/Upper Rio Puerco DB/Rasters/Hydrology/Rainfall/nexrad_prec.metaVHC"),0.0f,0,new java.io.File("/tmp/"),routingParams).executeSimulation();
    ...
    public static void subMain4(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiFileWithHillslope(1063,496,matDirs,magnitudes,metaModif,stormFile,0.0f,2,new java.io.File("/Users/ricardo/simulationResults/walnutGulch/"),routingParams).executeSimulation();
    }
    ...
    //stormFile=new java.io.File("/CuencasDataBases/Iowa_Rivers_DB/Rasters/Hydrology/storms/observed_events/EventIowaJuneMPE/May15toJune26/hydroNexrad.metaVHC");

        float infil=0.0f;

        new SimulationToAsciiFileWithHillslope(1570, 127, matDirs, magnitudes, metaModif, stormFile, infil, 5, new java.io.File("/Users/ricardo/simulationResults/ClearCreek/"), routingParams).executeSimulation();
        //new SimulationToAsciiFileWithHillslope(778, 368, matDirs, magnitudes, metaModif, stormFile, infil, 5, new java.io.File("/Users/ricardo/simulationResults/ClearCreek/"), routingParams).executeSimulation();
