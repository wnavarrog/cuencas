...
//        thisHillsInfo.setInfManager(infilMan);
        ...
        double extraSimTime=340D*Math.pow(2.0D,(basinOrder-1));
        ...
        if(stormFile == null){
            ...
            rainRunoffRaining.jumpsRunToCompleteAsciiFileChi(storm.stormInitialTimeInMinutes()+numPeriods*rainDuration,(storm.stormInitialTimeInMinutes()+(numPeriods+1)*rainDuration)+extraSimTime,5,initialCondition,newfile,linksStructure,thisNetworkGeom);
            
        } else {
            for (int k=0;k<numPeriods;k++) {
                System.out.println("Period "+(k+1)+" of "+numPeriods);
                rainRunoffRaining.jumpsRunToCompleteAsciiFileChi(storm.stormInitialTimeInMinutes()+k*storm.stormRecordResolutionInMinutes(),storm.stormInitialTimeInMinutes()+(k+1)*storm.stormRecordResolutionInMinutes(),10,initialCondition,newfile,linksStructure,thisNetworkGeom);
                initialCondition=rainRunoffRaining.finalCond;
                rainRunoffRaining.setBasicTimeStep(10/60.);
            }
            ...
            rainRunoffRaining.jumpsRunToCompleteAsciiFileChi(storm.stormInitialTimeInMinutes()+numPeriods*storm.stormRecordResolutionInMinutes(),(storm.stormInitialTimeInMinutes()+(numPeriods+1)*storm.stormRecordResolutionInMinutes())+extraSimTime,10,initialCondition,newfile,linksStructure,thisNetworkGeom);
        }
    ...
    public static void main(String args[]) {
        ...
        try{
            ...
            subMain5_1(args);   //Case Clear Creek (5m Resolution) June 3 to 7
    ...
    public static void subMain0(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiFileChi(x_outlet,y_outlet,matDirs,magnitudes,metaModif,50,1,0.0f,1,new java.io.File("/home/ricardo/workFiles/myWorkingStuff/MateriasDoctorado/PhD_Thesis/results/flowSimulations/realBasins"),routingParams).executeSimulation();
    ...
    public static void subMain1(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiFileChi(32,32,matDirs,magnitudes,metaModif,6,10,0.0f,2,new java.io.File("/tmp/"),routingParams).executeSimulation();
        new SimulationToAsciiFileChi(32,32,matDirs,magnitudes,metaModif,6,10,0.0f,1,new java.io.File("/tmp/"),routingParams).executeSimulation();
        ...
        new SimulationToAsciiFileChi(777, 324,matDirs,magnitudes,metaModif,stormFile,0.0f,0,new java.io.File("/tmp/"),routingParams);
        ...
        new SimulationToAsciiFileChi(777, 324,matDirs,magnitudes,metaModif,stormFile,0.0f,2,new java.io.File("/tmp/"),routingParams);
    ...
    public static void subMain2(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiFileChi(194,281,matDirs,magnitudes,metaModif,  20,5,0.0f,2,new java.io.File("/home/ricardo/simulationResults/walnutGulch/"),routingParams).executeSimulation();
    }
    ...
    public static void subMain3(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiFileChi(381, 221,matDirs,magnitudes,metaModif,new java.io.File("/CuencasDataBases/Upper Rio Puerco DB/Rasters/Hydrology/Rainfall/nexrad_prec.metaVHC"),0.0f,0,new java.io.File("/tmp/"),routingParams).executeSimulation();
    ...
    public static void subMain4(String args[]) throws java.io.IOException, VisADException {
        ...
        new SimulationToAsciiFileChi(1063,496,matDirs,magnitudes,metaModif,stormFile,0.0f,5,new java.io.File("/home/ricardo/simulationResults/walnutGulch/"),routingParams).executeSimulation();
    }
...
//        new SimulationToAsciiFile(778, 368, matDirs, magnitudes, metaModif, 10000.0f, 15.0f, 30.0f, 2, new java.io.File("E:/CUENCAS/ClearCreek_Database/Results/"), routingParams).executeSimulation();
        new SimulationToAsciiFileChi(1570, 127, matDirs, magnitudes, metaModif, 1000.0f, 15.0f, 30.0f, 2, new java.io.File("C:/CuencasDataBases/ClearCreek_Database/Results/"), routingParams).executeSimulation();
        ...
        new SimulationToAsciiFileChi(1570, 127, matDirs, magnitudes, metaModif, stormFile, infil, 5, new java.io.File("/Users/ricardo/simulationResults/ClearCreek/"), routingParams).executeSimulation();
        ...
        for (double lam1 = 3; lam1 <= 3; lam1 += 1) {
            ...
            for (double lam2 = -1; lam2 <= -1; lam2 += 1.0) {
                ...
                for (float intV = 3.5f; intV <= 3.5f; intV += 1.0) {
                    ...
                    new SimulationToAsciiFileChi(1570, 127, matDirs, magnitudes, metaModif, stormFile, infil, 5, new java.io.File("/home/ricardo/simulationResults/ClearCreek/"), routingParams).executeSimulation();
                }
            }
        }
    }
...
//        new SimulationToAsciiFileChi(x, y, matDirs, magnitudes, metaModif, 20.0f, 30.0f, 0.0f, 5, new java.io.File("/Users/ricardo/simulationResults/ClearCreek/"), routingParams).executeSimulation();
//
//        System.exit(0);
        ...
        //stormFile=new java.io.File("/CuencasDataBases/Iowa_Rivers_DB/Rasters/Hydrology/storms/observed_events/EventIowaJune/EventIowaJune8thNoon/hydroNexrad.metaVHC");
        //stormFile=new java.io.File("/CuencasDataBases/Iowa_Rivers_DB/Rasters/Hydrology/storms/observed_events/EventIowaJuneMPE/May28toJune11/hydroNexrad.metaVHC");
        //stormFile=new java.io.File("/CuencasDataBases/Iowa_Rivers_DB/Rasters/Hydrology/storms/observed_events/EventIowaJuneMPE/June3toJune5/hydroNexrad.metaVHC");
        //stormFile=new java.io.File("/CuencasDataBases/Iowa_Rivers_DB/Rasters/Hydrology/storms/observed_events/EventIowaJuneHydroNEXRAD/June3toJune5/hydroNexrad.metaVHC");
    ...
    public static void subMain6(String args[]) throws java.io.IOException, VisADException {
        ...
        routingParams.put("v_o", 0.5f);
        new SimulationToAsciiFileChi(1425, 349, matDirs, magnitudes, metaModif, stormFile, infil, 2, new java.io.File("/Users/ricardo/simulationResults/SquawCreek/"), routingParams).executeSimulation();
...
//        int[] event_num={35};
        ...
        for (int i : event_num) {
            ...
            new SimulationToAsciiFileChi(44, 111, matDirs, magnitudes, metaModif, stormFile, infil, 5, new java.io.File("/Users/ricardo/simulationResults/GoodwinCreek/"), routingParams).executeSimulation();
