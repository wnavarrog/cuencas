 ...
 * @author ricardo
 */
public class ReadSnowDataDailyOverIowa {
    ...
    public ReadSnowDataDailyOverIowa() throws java.io.IOException {
        ...
        java.io.File dirOut=new java.io.File("/Users/ricardo/rawData/SnowData/Daily2013/sidads.colorado.edu/DATASETS/NOAA/G02158/unmasked/2013/");
        hydroScalingAPI.util.fileUtilities.DotFilter myFiltro=new hydroScalingAPI.util.fileUtilities.DotFilter("dat");
        ...
        for (int jj = 0; jj < lasQueSi.length; jj++) {
            ...
            System.out.print(lasQueSi[kk].getName()+",");
            ...
            minLon=-130.512916666665;
            minLat=24.0995833333335;
            ...
            for (int i = 0; i < accumulators.length; i++) accumulators[i]/=(counters[i]*1000/24.0);
    ...
    public static void main(String[] args) {
        ...
        try{
            new hydroScalingAPI.examples.io.ReadSnowDataDailyOverIowa();
