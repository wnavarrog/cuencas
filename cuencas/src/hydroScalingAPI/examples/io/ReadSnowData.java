...
public class ReadSnowData {
    ...
    public ReadSnowData() throws java.io.IOException {
        ...
        java.io.File dataInputFile=new java.io.File("/Users/ricardo/rawData/snow/us_ssmv11034tS__T0001TTNATS2011012413HP001.bil");
        ...
        System.out.println("Hillslope-ID SWE");

        for (int i=0;i<accumulators.length;i++) {
            accumulators[i]/=counters[i];
            System.out.println((i+1)+" "+accumulators[i]);
        }
