...
public class NetworkTools extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BasinDivideToPoly.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        ...
        BasinPolyToKML.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        BasinPolyToKML.setText("Export KML Layers");
        BasinPolyToKML.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BasinPolyToKMLActionPerformed(evt);
            }
        });
        getContentPane().add(BasinPolyToKML);

        TribsInput.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        TribsInput.setText("tRIBS Input Module");
        TribsInput.setEnabled(false);
    ...
    private void BasinPolyToKMLActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BasinPolyToKMLActionPerformed
        ...
        try{
            ...
            hydroScalingAPI.util.geomorphology.objects.Basin myCuenca=new hydroScalingAPI.util.geomorphology.objects.Basin(xOut,yOut,matDir,metaDatos);
            hydroScalingAPI.io.MetaNetToKML exporter=new hydroScalingAPI.io.MetaNetToKML(metaDatos,fc.getSelectedFile(),myCuenca,matDir,myCuenca.toString());
    ...
    private javax.swing.JButton BasinPolyToKML;
